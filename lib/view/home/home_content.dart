...
class HomeContent extends StatefulWidget {
  ...
  const HomeContent({Key key, this.coronaProvinceId}) : super(key: key);
...
class _HomeContentState extends State<HomeContent> {
  ...
  void initState() {
    _listCoronaCases = <CoronaCases>[
      CoronaCases(title: "Positif", count: 0),
      CoronaCases(title: "Sembuh", count: 0),
      CoronaCases(title: "Meninggal", count: 0),
      CoronaCases(title: "Perawatan", count: 0)
    ];
      ...
      child: Column(
        children: <Widget>[
          GridView.builder(
            primary: false,
            shrinkWrap: true,
            gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(maxCrossAxisExtent: 512.0, childAspectRatio: 1.5), 
            ...
            ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                return Card(
                  ...
                  child: ListTile(title: Text(_listData[index].province),
                  trailing: Icon(Icons.chevron_right),
                  onTap: (){
                    Navigator.pushNamed(context, Env.detailRoute, arguments: _listData[index]);
                  },),
                );
              },
  ...
  return Card(
    ...
    child: Center(
      child: ListView(
        ...
        shrinkWrap: true,
        children: <Widget>[
          Text("${_listCoronaCases[index].title}",
          style: TextStyle(
            fontSize: 32.0,
          ),
          ...
          Text("${_listCoronaCases[index].count}",
          style: TextStyle(
            fontSize: 64.0,
          ),
          textAlign: TextAlign.center,
